...
web_url = 'https://www.bukalapak.com/c/aksesoris-rumah-7354/lampu-7366?page=' # Menyimpan link web bukalapak yang akan discraping ke variabel.
...
csv_file = 'data_lampu.csv'  # Deklarasi nama file CSV untuk menyimpan data.
...
data = pd.read_csv("data_lampu.csv")
...
# Menambahkan judul.
plt.title("Histogram Aksesoris Komputer Berdasarkan Alamat")

# Menyimpan Histogram dalam format JPG dengan nama file 'Histogram_Aksesoris.jpg'.
plt.savefig('Histogram_AksesorisKomputer.jpg', dpi=300, bbox_inches='tight')
...
# Menambahkan judul.
plt.title("Pie Chart Aksesoris Komputer Berdasarkan Alamat")

# Menyimpan Pie Chart dalam format JPG dengan nama file 'PieChart_Aksesoris.jpg'.
plt.savefig('PieChart_AksesorisKomputer.jpg', dpi=300, bbox_inches='tight')
